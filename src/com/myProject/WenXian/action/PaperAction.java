...
import com.myProject.WenXian.dao.*;
	public  class PaperAction extends HttpServlet 
	{
		public void destroy()
		{destroy();}
		...
		model.setAbstract(request.getParameter("Abstract"));
		model.setCTime(request.getParameter("CTime"));
		model.setPc(request.getParameter("Pc"));
		model.setFileName(request.getParameter("FileName"));
		model.setCreator(Integer.parseInt(request.getParameter("Creator")));
		model.setCreatorName(request.getParameter("CreatorName"));
		model.setClassic(Integer.parseInt(request.getParameter("Classic")));
