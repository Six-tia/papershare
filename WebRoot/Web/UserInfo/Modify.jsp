		...
		<div class="formbody">
			...
			<ul class="forminfo">
				...
				<li><label> 电话:</label> <input type="text" id="UTel"
					name="UTel" value="<%=model.getUTel()%>" class="dfinput" /></li>
				<li><label> 状态:</label> <div class="vocation"><select name="UStatus"
					class="select1">
				...
				<li><label> 角色:</label> <div class="vocation"><select name="Role"
					class="select1">
