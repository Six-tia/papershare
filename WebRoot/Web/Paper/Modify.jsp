		...
		<div class="formbody">
			...
			<ul class="forminfo">
				<li><label> 标题:</label> <input type="text" id="Title"
					name="Title" value="<%=model.getTitle()%>" class="dfinput" /></li>
				<li><label> 摘要:</label> <input type="text" id="Abstract"
					name="Abstract" value="<%=model.getAbstract()%>" class="dfinput" />
				</li>
				<li><label> 发表日期:</label> <input type="text" name="CTime"
					id="CTime"
					onclick="WdatePicker({el:'CTime','dateFmt':'yyyy-MM-dd'})"
					value="<%=model.getCTime()%>" class="dfinput" /></li>
				<li><label> 刊物:</label> <input type="text" id="Pc" name="Pc"
					value="<%=model.getPc()%>" class="dfinput" />
					<input type="hidden" id="Creator"
					name="Creator" value="<%=model.getCreator()%>" class="dfinput" />
					
					<input type="hidden" id="CreatorName"
					name="CreatorName" value="<%=model.getCreatorName()%>"
					class="dfinput" />
					</li>
				<li><label> 文件:</label> <input type="text" id="FileName"
					name="FileName" class="dfinput" value="<%=model.getFileName()%>" />
					<input type="button" id="uploadFileName" value="上传" /> <script>
				...
				<li><label> 经典程度:</label> <input type="text" id="Classic"
					name="Classic" value="<%=model.getClassic()%>" class="dfinput" />
				</li>
